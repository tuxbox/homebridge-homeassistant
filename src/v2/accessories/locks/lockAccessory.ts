import { Service, PlatformAccessory, Logger, Characteristic, CharacteristicValue } from 'homebridge';
import { HomebridgeMqttPlatform } from '../../platform';
import { ActorCommandPayload, ActorStatePayload, Payload, SensorPayload } from '../../model/mqtt/mqtt-payload';

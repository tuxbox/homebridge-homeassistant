 ...
 */
export class VoltageSensorPlatformAccessory extends BaseSensorPlatformAccessory<number> {
  ...
  override updateCharacteristic(value: number) {
    ...
    this.service.updateCharacteristic(this.platform.Characteristic.Voltage, value);
  }

 ...
 */
export class BatterySensorPlatformAccessory<T extends AccessoryConfiguration, P extends DynamicPlatformPlugin>
  ...
  override createService() : Service {
    return this.accessory.getService(HAPService.Battery) ||
            this.accessory.addService(HAPService.Battery);
  }
  ...
  protected stateCharacteristic(): WithUUID<new () => HAPCharacteristic> {
    return HAPCharacteristic.BatteryLevel;
  }
